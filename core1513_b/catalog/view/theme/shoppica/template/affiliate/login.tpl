<?php echo $header; ?>
  ...
  <div id="content" class="container_<?php echo $container; ?>">
    ...
    <div id="login_page" class="grid_<?php echo $main; ?>">
      ...
      <span class="clear s_mb_20 s_pt_10 border_ddd"></span>
      
      <div class="s_2col_wrap clearfix">
        <div class="s_col_1_2">
          <h2 class="s_title_1"><?php echo $text_new_affiliate; ?></h2>
          <div class="clear"></div>
        ...
        <div class="s_col_1_2 s_col_last">
          <h2 class="s_title_1"><?php echo $text_returning_affiliate; ?></h2>
          <div class="clear"></div>
