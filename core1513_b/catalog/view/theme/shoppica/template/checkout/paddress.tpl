...
<div id="<?php echo $type; ?>-existing">
  <select name="address_id" style="width: 100%; margin-bottom: 15px;" size="5">
    ...
    <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?> , <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?>, <?php echo $address['country']; ?> , <?php echo $text_taxid1; ?> <?php echo $address['taxid1']; ?> , <?php echo $text_taxid2; ?> <?php echo $address['taxid2']; ?></option>
    <?php } else { ?>
